            ...
            if (btn.classList.contains('publish-btn')) {
                ...
                if (text === 'Pay with Apple Pay') {
                    ...
                    setTimeout(() => {
                        ...
                        const modal = btn.closest('.playbox-modal-overlay');
                        if (modal) modal.classList.remove('active');
                    }, 1500);
                } else if (text === 'Copy Link') {
                    // Try to copy the text to clipboard
                    const linkText = 'https://nextgen-ai.com/t/bbc-miss-a83d2';
                    ...
                    window.showToast('Generation started', 'info');
                }
            } else {
